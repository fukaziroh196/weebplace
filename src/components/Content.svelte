...
<style>
  ...
  .hex-row-2 {
    margin-left: 85px; /* Увеличено смещение вправо для правильного сотообразного узора */
    margin-top: 0; /* Убрано перекрытие, чтобы кнопки не заезжали друг на друга */
  }
  
  @media (max-width: 768px) {
    .hex-row-2 {
      margin-left: 70px; /* Увеличено смещение для мобильных */
      margin-top: 0; /* Убрано перекрытие */
    }
  }
