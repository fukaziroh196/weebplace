    ...
    <svg width="0" height="0" style="position: absolute;">
      <defs>
        <clipPath id="hexagon-rounded" clipPathUnits="objectBoundingBox">
          <!-- Правильный шестиугольник с плавными скруглениями на всех 6 углах -->
          <!-- Используем кубические кривые для более плавных переходов -->
          <path d="M 0.5 0.05
                   C 0.52 0.05 0.54 0.06 0.56 0.07
                   L 0.93 0.23
                   C 0.97 0.24 0.99 0.25 0.99 0.26
                   C 0.99 0.27 0.97 0.28 0.93 0.29
                   L 0.93 0.71
                   C 0.97 0.72 0.99 0.73 0.99 0.74
                   C 0.99 0.75 0.97 0.76 0.93 0.77
                   L 0.56 0.93
                   C 0.54 0.94 0.52 0.95 0.5 0.95
                   C 0.48 0.95 0.46 0.94 0.44 0.93
                   L 0.07 0.77
                   C 0.03 0.76 0.01 0.75 0.01 0.74
                   C 0.01 0.73 0.03 0.72 0.07 0.71
                   L 0.07 0.29
                   C 0.03 0.28 0.01 0.27 0.01 0.26
                   C 0.01 0.25 0.03 0.24 0.07 0.23
                   L 0.44 0.07
                   C 0.46 0.06 0.48 0.05 0.5 0.05
                   Z" />
        </clipPath>
      </defs>
    </svg>
...
<style>
  ...
  .hex-row-2 {
    margin-left: 135px; /* Еще чуть-чуть увеличено смещение вправо */
    margin-top: -20px; /* Поднимаем кнопки выше, но не сильно чтобы не заезжали */
  }
  
  @media (max-width: 768px) {
    .hex-row-2 {
      margin-left: 115px; /* Еще чуть-чуть увеличено смещение для мобильных */
      margin-top: -15px; /* Поднимаем для мобильных */
    }
  }
