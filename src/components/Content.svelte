...
<style>
  ...
  .hex-row-2 {
    margin-left: 0; /* Убрано смещение для квадратных кнопок */
    margin-top: 0; /* Убрано смещение для квадратных кнопок */
  }
  
  @media (max-width: 768px) {
    .hex-row-2 {
      margin-left: 0; /* Убрано смещение для мобильных */
      margin-top: 0; /* Убрано смещение для мобильных */
    }
  }
