...
<style>
  ...
  .quiz-cards-honeycomb {
    ...
    max-width: 800px;
    margin: 0 auto;
    margin-left: -350px; /* Сдвигаем только центральные кнопки влево */
  }
  ...
  .hex-row-1 {
    gap: 5rem; /* Увеличенный отступ между кнопками в верхнем ряду */
  }
  
  .hex-row-2 {
    margin-left: 150px; /* Уменьшенный сдвиг второго ряда вправо */
  ...
  @media (max-width: 768px) {
    .hex-row-2 {
      margin-left: 120px; /* Уменьшенный сдвиг для мобильных */
