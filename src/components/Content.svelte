...
<style>
  ...
  :global(:root[data-theme='dark']) {
    --bg-gradient-start: #1c1d22;
    --bg-gradient-end: #1c1d22;
    ...
    --admin-submit-shadow: 0 1rem 2rem rgba(0, 0, 0, 0.35);
    --admin-submit-shadow-hover: 0 1.375rem 2.625rem rgba(0, 0, 0, 0.45);
    --danger-color: #ffb7d5;
