    ...
    <svg width="0" height="0" style="position: absolute;">
      <defs>
        <clipPath id="hexagon-rounded" clipPathUnits="objectBoundingBox">
          <!-- Шестиугольник с максимальной шириной по горизонтали -->
          <!-- Левая и правая стороны почти на краю для максимальной ширины -->
          <path d="M 0.5 0.05
                   C 0.52 0.05 0.54 0.06 0.56 0.07
                   L 0.995 0.23
                   C 1 0.24 1 0.25 1 0.26
                   C 1 0.27 1 0.28 0.995 0.29
                   L 0.995 0.71
                   C 1 0.72 1 0.73 1 0.74
                   C 1 0.75 1 0.76 0.995 0.77
                   L 0.56 0.93
                   C 0.54 0.94 0.52 0.95 0.5 0.95
                   C 0.48 0.95 0.46 0.94 0.44 0.93
                   L 0.005 0.77
                   C 0 0.76 0 0.75 0 0.74
                   C 0 0.73 0 0.72 0.005 0.71
                   L 0.005 0.29
                   C 0 0.28 0 0.27 0 0.26
                   C 0 0.25 0 0.24 0.005 0.23
                   L 0.44 0.07
