...
<style>
  ...
  .hex-row-1 {
    gap: 3.5rem; /* Умеренно увеличенный отступ между кнопками в верхнем ряду */
  }
  
  .hex-row-2 {
    margin-left: 180px; /* Максимально увеличенный сдвиг нижнего ряда вправо */
    margin-top: 0;
    gap: 3.5rem; /* Такой же отступ между кнопками в нижнем ряду */
  }
  
  @media (max-width: 768px) {
    .hex-row-2 {
      margin-left: 140px; /* Максимально увеличенный сдвиг для мобильных */
      margin-top: 0;
    }
  }
